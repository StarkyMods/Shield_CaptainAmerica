...
public class ShieldCapSignatureEnergyLoad extends SimpleInstantInteraction {

    @Nonnull
    public static final BuilderCodec<ShieldCapSignatureEnergyLoad> CODEC =
            BuilderCodec
                    .builder(
                            ShieldCapSignatureEnergyLoad.class,
                            ShieldCapSignatureEnergyLoad::new,
    ...
    protected void firstRun(@Nonnull InteractionType type,
        ...
        Float cached = ShieldCapSignatureEnergyStore.load(uuid);
        if (cached == null) {
            return;
        }

        int signatureEnergyId = DefaultEntityStatTypes.getSignatureEnergy();
        statMap.setStatValue(signatureEnergyId, cached);
    }
