...
public final class ShieldCapVisualRefreshInteraction extends SimpleInstantInteraction {
    @Nonnull
    public static final BuilderCodec<ShieldCapVisualRefreshInteraction> CODEC =
            BuilderCodec
                    .builder(
                            ShieldCapVisualRefreshInteraction.class,
                            ShieldCapVisualRefreshInteraction::new,
                            SimpleInstantInteraction.CODEC
                    )
                    .documentation("Refreshes the ShieldCap back visual using the configured variant priority.")
                    .build();
